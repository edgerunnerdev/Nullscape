...
CodexWindow::CodexWindow() : UI::Window( "Codex window" )
{
...
{
	m_pButton = std::make_shared<UI::Button>( name, [this](std::any userData){ OnButtonPressed(); }, nullptr, pEntryToggleGroup );
	m_pButton->SetDynamic( true );
