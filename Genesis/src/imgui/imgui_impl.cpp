...
bool ImGuiImpl::m_DevMenuEnabled = false;
...
void ImGuiImpl::NewFrame( float delta )
{
    ...
    if ( IsInitialised() && IsEnabled() && IsDevMenuEnabled() && ImGui::BeginMainMenuBar() )
    {
...
bool ImGuiImpl::HandleEvent( SDL_Event* pEvent )
{
    ...
    case SDL_KEYUP: {
        ...
        return false; // Intentionally don't handle these events.
    }
    }
    return false;
}
...
bool ImGuiImpl::IsDevMenuEnabled()
{
    return m_DevMenuEnabled;
}

void ImGuiImpl::EnableDevMenu( bool state )
{
    m_DevMenuEnabled = state;
}

void ImGuiImpl::RegisterDevMenu( const std::string& menuRoot, const std::string& menuName, bool* pShow )
{
    Menu menu;
    menu.name = menuName;
    menu.pShow = pShow;
...
void ImGuiImpl::UnregisterDevMenu( const std::string& menuRoot, const std::string& menuName )
{
