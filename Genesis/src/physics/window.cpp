...
void Window::Update(float delta)
{
    if (m_Open)
    {
        ...
        if (ImGui::CollapsingHeader("Simulation statistics"))
        {
            ...
            ImGui::Text("btCollisionObject");
            ImGui::NextColumn();
            ImGui::Text("%d", m_pSimulation->m_pWorld->getCollisionWorld()->getNumCollisionObjects());
            ImGui::NextColumn();

            ImGui::Text("btCollisionShape");
            ImGui::NextColumn();
            ImGui::Text("%d", sActiveShapes);
            ImGui::NextColumn();

            ImGui::Text("RigidBody");
            ImGui::NextColumn();
            ImGui::Text("%zu", m_pSimulation->m_RigidBodies.size());
            ImGui::NextColumn();

            ImGui::Text("Ghost");
            ImGui::NextColumn();
            ImGui::Text("%zu", m_pSimulation->m_Ghosts.size());
            ImGui::NextColumn();
