...
void RenderTarget::LogCreationError(const std::string& name, GLenum status)
{
    ...
    case GL_FRAMEBUFFER_UNSUPPORTED: reason = "Unsupported framebuffer format"; break;
    case GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT: reason = "Framebuffer incomplete, missing attachment"; break;
    case GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER: reason = "Framebuffer incomplete, missing draw buffer"; break;
    case GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER: reason = "Framebuffer incomplete, missing read buffer"; break;
    case GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT: reason = "Framebuffer incomplete attachment"; break;
