...
inline const glm::vec3& SceneCamera::GetTarget() const
{
    return mTarget;
}
inline void SceneCamera::SetTarget(const glm::vec3& target)
{
    mTarget = target;
}
inline void SceneCamera::SetTarget(float x, float y, float z)
{
